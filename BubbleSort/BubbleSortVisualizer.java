...
public class BubbleSortVisualizer {
    ...
    private static int currentIndex1 = -1; // For currently comparing element 1
    private static int currentIndex2 = -1; // For currently comparing element 2
            ...
            new Thread(() -> {
                for (int i = 0; i < array.length - 1; i++) {
                    for (int j = 0; j < array.length - 1 - i; j++) {
                        ...
                        currentIndex1 = j; // Mark current element 1
                        currentIndex2 = j + 1; // Mark current element 2
                        panel.repaint(); // Repaint the panel before comparison
                        ...
                        // Mark the current index as sorted after the inner loop
